...
/**
 * A {@link android.view.View.OnTouchListener} that makes the list items in a {@link android.widget.ListView} dismissable.
 * {@link android.widget.ListView} is given special treatment because by default it handles touches for its list
 ...
 * android.widget.ListView#setOnScrollListener(android.widget.AbsListView.OnScrollListener)}, passing in the scroll listener
 ...
 * com.zms.listcard.controller.SwipeDismissRecyclerViewTouchListener} is paused during list view scrolling.</p>
 * <p/>
 * <p>Example usage:</p>
 * <p/>
 * <pre>
 ...
 * <p/>
 * <p>For a generalized {@link android.view.View.OnTouchListener} that makes any view dismissable, see {@link
...
public class SwipeDismissRecyclerViewTouchListener implements View.OnTouchListener {
	...
	/**
	 * The callback interface used by {@link com.zms.listcard.controller.SwipeDismissRecyclerViewTouchListener} to inform its
	...
	public interface DismissCallbacks {
		 ...
		 *
		 * @param recyclerView
		 * 		The originating {@link android.widget.ListView}.
	 ...
	 * {@link android.widget.ListView#setOnScrollListener(android.widget.AbsListView.OnScrollListener)}. If a scroll listener is
	 * already assigned, the caller should still pass scroll changes through to this listener. This
	 * will ensure that this {@link com.zms.listcard.controller.SwipeDismissRecyclerViewTouchListener} is paused during list
	 * view scrolling.</p>
	 *
	 * @see com.zms.listcard.controller.SwipeDismissRecyclerViewTouchListener
	 */
